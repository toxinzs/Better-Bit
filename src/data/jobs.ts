...
export const JOBS: Job[] = [
  ...
  { title: "Bank Teller", salary: 38000, minAge: 18, minSmarts: 50 },
  { title: "Electrician", salary: 52000, minAge: 20, minSmarts: 55 },
  { title: "Nurse", salary: 68000, minAge: 22, minSmarts: 65, requiresCollege: true },
  { title: "Software Engineer", salary: 95000, minAge: 21, minSmarts: 75, requiresCollege: true },
  { title: "Accountant", salary: 62000, minAge: 21, minSmarts: 65, requiresCollege: true },
  { title: "Lawyer", salary: 120000, minAge: 24, minSmarts: 85, requiresCollege: true },
  { title: "Doctor", salary: 180000, minAge: 26, minSmarts: 90, requiresCollege: true },
  { title: "Marketing Manager", salary: 74000, minAge: 23, minSmarts: 60, requiresCollege: true },
  { title: "Teacher", salary: 48000, minAge: 22, minSmarts: 60, requiresCollege: true },
];

export function availableJobs(age: number, smarts: number, hasCollegeDegree: boolean): Job[] {
  return JOBS.filter(
    (j) =>
      age >= j.minAge &&
